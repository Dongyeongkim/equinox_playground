...
rssm = RSSM(jax.random.key(0), deter, hidden, action_dim, latent_dim, latent_cls, channel_depth, channel_mults)
...
carry, out = rssm.observe(jax.random.key(0), carry, actions, embeds, resets)
